...
export const PagoComision = () => {
  const { devotos, fetchDevotoById, devoto, loading, searchResults, searchDevotos } = useDevoto();
        ...
        <div className="bg-white rounded-b-xl shadow-md divide-y divide-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className={`font-medium ${estadoPago === "PAGADO" ? "text-green-600" :
                  ...
                  <div>
                    ...
                    <p className={`font-medium text-lg ${saldoPendiente > 0 ? "text-red-600" : "text-green-600"
                      }`}>
          ...
          {turnoSeleccionado && (
            <div className="p-6 pt-0">
              <button
                className={`w-full py-3 px-4 rounded-lg font-medium text-white transition-all ${loadingPago ? 'bg-[#142130]' : 'bg-[#142130] hover:bg-purple-[#142130] shadow-md hover:shadow-lg'
